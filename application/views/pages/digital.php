    ...
    <div class="row ">
      <div class="col-md-8">
          ...
          <div class="social-media">
            <!-- <?php echo $email_msg; ?> -->
            <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo base_url(); ?>digital-marketing-services-kolhapur">
            ...
            <a class="display_mobile" id="whats_app" target="_blank" href="https://web.whatsapp.com/send?text=<?php echo base_url(); ?>digital-marketing-services-kolhapur">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="portfolio_form" method="post" class="message-form clear" action="<?php echo base_url(); ?>Welcome/send_service_email">
              <input type="hidden" name="page_url" value="<?php echo base_url(); ?>digital-marketing-services-kolhapur">
              <input type="hidden" name="title" value="Shout loud on internet with digital marketing services in Kolhapur">
              <div class="form-row">
