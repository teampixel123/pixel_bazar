...
<section class="home-about" id="about">
  ...
  <div class="row">
    <div class="col-md-6 col-12 pb-3">
      ...
      <a data-href="<?php echo base_url(); ?>assets/images/site/team_s.jpg" class="boxout2 progressive replace">
        <img src="<?php echo base_url(); ?>assets/images/site/team_s.jpg" class="preview" alt="logo design, website design, graphic design, web design, web page design, company logo, website development, web design company, business logo, website design services in kolhapur, logo design services in kolhapur, Graphic design services in kolhapur" />
      </a>
    </div>
...
<section class="home-services d-none d-sm-block" id="services">
    ...
    <div id="Paris" class="tabcontent  shadow">
      <!-- <div class="cancel float-right" onclick="alert();"><svg  x="0" y="200" width="60" height="20" viewBox="0 0 352 512"><path fill="currentColor" d="M242.72 256l100.07-100.07c12.28-12.28 12.28-32.19 0-44.48l-22.24-22.24c-12.28-12.28-32.19-12.28-44.48 0L176 189.28 75.93 89.21c-12.28-12.28-32.19-12.28-44.48 0L9.21 111.45c-12.28 12.28-12.28 32.19 0 44.48L109.28 256 9.21 356.07c-12.28 12.28-12.28 32.19 0 44.48l22.24 22.24c12.28 12.28 32.2 12.28 44.48 0L176 322.72l100.07 100.07c12.28 12.28 32.2 12.28 44.48 0l22.24-22.24c12.28-12.28 12.28-32.19 0-44.48L242.72 256z" class=""></path></svg></div> -->
      <div class="sub-tabcontent">
      <img class="service-image" src="<?php echo base_url(); ?>assets/images/site/GraphicS.gif" alt="">
    ...
    <div id="Tokyo" class="tabcontent shadow">
      <!-- <div class="cancel float-right" onclick="alert();"><svg  x="0" y="200" width="60" height="20" viewBox="0 0 352 512"><path fill="currentColor" d="M242.72 256l100.07-100.07c12.28-12.28 12.28-32.19 0-44.48l-22.24-22.24c-12.28-12.28-32.19-12.28-44.48 0L176 189.28 75.93 89.21c-12.28-12.28-32.19-12.28-44.48 0L9.21 111.45c-12.28 12.28-12.28 32.19 0 44.48L109.28 256 9.21 356.07c-12.28 12.28-12.28 32.19 0 44.48l22.24 22.24c12.28 12.28 32.2 12.28 44.48 0L176 322.72l100.07 100.07c12.28 12.28 32.2 12.28 44.48 0l22.24-22.24c12.28-12.28 12.28-32.19 0-44.48L242.72 256z" class=""></path></svg></div> -->
      <div class="sub-tabcontent">
      <img class="service-image mt-5" src="<?php echo base_url(); ?>assets/images/site/Logo2S.jpg" alt="">
    ...
    <div id="delhi" class="tabcontent shadow">
      <!-- <div class="cancel float-right" onclick="alert();"><svg  x="0" y="200" width="60" height="20" viewBox="0 0 352 512"><path fill="currentColor" d="M242.72 256l100.07-100.07c12.28-12.28 12.28-32.19 0-44.48l-22.24-22.24c-12.28-12.28-32.19-12.28-44.48 0L176 189.28 75.93 89.21c-12.28-12.28-32.19-12.28-44.48 0L9.21 111.45c-12.28 12.28-12.28 32.19 0 44.48L109.28 256 9.21 356.07c-12.28 12.28-12.28 32.19 0 44.48l22.24 22.24c12.28 12.28 32.2 12.28 44.48 0L176 322.72l100.07 100.07c12.28 12.28 32.2 12.28 44.48 0l22.24-22.24c12.28-12.28 12.28-32.19 0-44.48L242.72 256z" class=""></path></svg></div> -->
      <div class="sub-tabcontent">
      <img class="service-image mt-5" src="<?php echo base_url(); ?>assets/images/site/brandingS.jpeg" alt="">
    ...
    <div class="row">
      <div class="col-md-8 service-row-text">
        ...
        <div id="London1" class="tabcontent2 shadow">
          <!-- <div class="cancel float-right" onclick="alert();"><svg  x="0" y="200" width="60" height="20" viewBox="0 0 352 512"><path fill="currentColor" d="M242.72 256l100.07-100.07c12.28-12.28 12.28-32.19 0-44.48l-22.24-22.24c-12.28-12.28-32.19-12.28-44.48 0L176 189.28 75.93 89.21c-12.28-12.28-32.19-12.28-44.48 0L9.21 111.45c-12.28 12.28-12.28 32.19 0 44.48L109.28 256 9.21 356.07c-12.28 12.28-12.28 32.19 0 44.48l22.24 22.24c12.28 12.28 32.2 12.28 44.48 0L176 322.72l100.07 100.07c12.28 12.28 32.2 12.28 44.48 0l22.24-22.24c12.28-12.28 12.28-32.19 0-44.48L242.72 256z" class=""></path></svg></div> -->
          <div class="sub-tabcontent">
            <img class="service-image mt-5" src="<?php echo base_url(); ?>assets/images/site/Digital MarketingS.jpeg" alt="">
      ...
      <div id="Paris1" class="tabcontent2 shadow">
        <!-- <div class="cancel float-right" onclick="alert();"><svg  x="0" y="200" width="60" height="20" viewBox="0 0 352 512"><path fill="currentColor" d="M242.72 256l100.07-100.07c12.28-12.28 12.28-32.19 0-44.48l-22.24-22.24c-12.28-12.28-32.19-12.28-44.48 0L176 189.28 75.93 89.21c-12.28-12.28-32.19-12.28-44.48 0L9.21 111.45c-12.28 12.28-12.28 32.19 0 44.48L109.28 256 9.21 356.07c-12.28 12.28-12.28 32.19 0 44.48l22.24 22.24c12.28 12.28 32.2 12.28 44.48 0L176 322.72l100.07 100.07c12.28 12.28 32.2 12.28 44.48 0l22.24-22.24c12.28-12.28 12.28-32.19 0-44.48L242.72 256z" class=""></path></svg></div> -->
        <div class="sub-tabcontent">
        <img class="service-image mt-5" src="<?php echo base_url(); ?>assets/images/site/SignageS.jpg" alt="">
      ...
      <div id="Tokyo1" class="tabcontent2 shadow">
        <!-- <div class="cancel float-right" onclick="alert();"><svg  x="0" y="200" width="60" height="20" viewBox="0 0 352 512"><path fill="currentColor" d="M242.72 256l100.07-100.07c12.28-12.28 12.28-32.19 0-44.48l-22.24-22.24c-12.28-12.28-32.19-12.28-44.48 0L176 189.28 75.93 89.21c-12.28-12.28-32.19-12.28-44.48 0L9.21 111.45c-12.28 12.28-12.28 32.19 0 44.48L109.28 256 9.21 356.07c-12.28 12.28-12.28 32.19 0 44.48l22.24 22.24c12.28 12.28 32.2 12.28 44.48 0L176 322.72l100.07 100.07c12.28 12.28 32.2 12.28 44.48 0l22.24-22.24c12.28-12.28 12.28-32.19 0-44.48L242.72 256z" class=""></path></svg></div> -->
        <div class="sub-tabcontent">
        <img class="service-image mt-5" src="<?php echo base_url(); ?>assets/images/site/Printing ServicesS.jpeg" alt="">
