...
<body class="main-page pc">
  ...
  <div class="banner">
	<div class="contain">
      ...
      <a id="whats_app" style="" href="https://web.whatsapp.com/send?phone=+919158995505">
      <i style="" class="">
...
<section class="home-about" id="about">
  <div class="container">
    ...
    <div class="row">
              ...
              <div class="service4 service-div group1">
                <div class="card card4">
                  <div class="card-body">
                    ...
                    <h5 class="card-title service-title">Strategic<br>Branding</h5>
      ...
      <div class="row text-center w-100 about-services-btn">
        <p class="text-center w-100">
          <a class="btn btn-lg btn-outline-warning2 margin-top mr-5" href="<?php echo base_url(); ?>Contact">JUST DROP US MAIL</a>
          <a class="btn btn-lg btn-outline-warning margin-top" href="<?php echo base_url(); ?>Creative-Design-Portfolio">SEE SUCCESSFULL WORK</a>
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="service-mobile">
    <div class="row">
      <div class="col-12">
        ...
        <div class="card card2">
          <div class="card-body text-center">
            ...
            <h5 class="card-title service-title">Logo<br>Design</h5>
            </div>
            <a class="btn btn-md btn-service" href="<?php echo base_url(); ?>logo-design-kolhapur">READ MORE</a>
          </div>
        </div>
        ...
        <div class="card card3">
          <div class="card-body text-center">
            ...
            <h5 class="card-title service-title">Graphic<br>Design</h5>
            </div>
              <a class="btn btn-md btn-service" href="<?php echo base_url(); ?>graphic-design-services-kolhapur">READ MORE</a>
          </div>
        </div>
      ...
      <div class="col-12 text-center">
        <p>
          <!-- <a class="btn btn-sm btn-outline-warning2 margin-top" href="<?php echo base_url(); ?>Contact">JUST DROP US MAIL</a> -->
          <a class="btn btn-md btn-outline-warning margin-top" href="<?php echo base_url(); ?>website-design-development-kolhapur">SEE SUCCESSFULL WORK</a>
        </p>
      </div>
    </div>
  </div>
...
<section class="home-services" id="services">
  <div class="container">
  <div class="row">
    <div class="col-md-4 col-12 services-box text-center">
      <div class="row-service row-service1">
        <div class="trans trans1 mx-auto">
          <svg class="mx-auto" x="0px" y="0px" width="75px" height="75px" viewBox="0 0 67 77" enable-background="new 0 0 77 77" xml:space="preserve">
<path  d="M49.101,28.311c-0.002-2.054-1.666-3.718-3.72-3.721h-8.676c0.342-1.816,0.515-3.66,0.515-5.508
        ...
        <h3 class="hvr-h3">DIGITAL<br>MARKETING</h3>
        <!-- <div class="line-hr"></div> -->
        <p class="paragraph">We have a vigorous approach towards providing digital marketing services which can bring extremely powerful results for the business. Any type of digital marketing campaign you want to run, we have got it all covered with prowess.</p>
        <a class="btn btn-md btn-service" href="<?php echo base_url(); ?>digital-marketing-services-kolhapur">READ MORE</a>
        <a class="btn btn-md btn-service-mob" href="<?php echo base_url(); ?>digital-marketing-services-kolhapur">READ MORE</a>
      </div>
    </div>

    <div class="col-md-4 col-12 services-box text-center">
      <div class="row-service row-service2">
        <div class="trans trans2 mx-auto">
          <svg class="mx-auto" x="0px" y="0px" width="75px" height="75px" viewBox="0 0 55 77" enable-background="new 0 0 77 77" xml:space="preserve">
<path d="M46.176,7.358c0.796,1.321,2.237,2.151,3.795,2.151c2.447,0,4.438-1.99,4.438-4.438
        ...
        <h3 class="hvr-h3">SIGNAGE<br>SOLUTIONS</h3>
        <!-- <div class="line-hr"></div> -->
        <p class="paragraph">Impress your customers at the very first go through high quality signage. We have expertise in designing both interior and exterior signage. You can trust on us when it comes to signage solutions because of our good experience in the same. So, leave your signage designing hassle to us for making your work easy.</p>
        <a class="btn btn-md btn-service" href="<?php echo base_url(); ?>signage-design-printing-kolhapur">READ MORE</a>
        <a class="btn btn-md btn-service-mob" href="<?php echo base_url(); ?>signage-design-printing-kolhapur">READ MORE</a>

      </div>
    </div>

    <div class="col-md-4 col-12 services-box text-center">
      <div class="row-service row-service3">
        <div class="trans trans3 mx-auto">
          <svg class="mx-auto" x="0px" y="0px" width="75px" height="75px" viewBox="0 0 60 77" enable-background="new 0 0 77 77" xml:space="preserve">
<path  d="M62.02,30.758L44.097,1.523l-12.12,7.43c-5.211,0-10.241,0-14.815,0c-0.511-0.007-1.03,0.589-1.043,1.063
       ...
       <rect x="28.869" y="38.206"  width="12.765" height="2.127"/>
        ...
        <h3 class="hvr-h3">PRINTING<br>SERVICES</h3>
        <p class="paragraph">A perfect color combination makes a print eye-catchy. If you are looking for business cards, Envelop, Flyers, Book, Brochure Printing or any type of printing. Then we are here to give you a professional look through our stunning prints.</p>
        <a class="btn btn-md btn-service" href="<?php echo base_url(); ?>printing-services-kolhapur">READ MORE</a>
        <a class="btn btn-md btn-service-mob" href="<?php echo base_url(); ?>printing-services-kolhapur">READ MORE</a>
      </div>
    </div>
  </div>
</div>
...
<section class="home-services-mob" id="services-mob">
  <div class="container">
  <div class="row">
    <div class="col-md-4 col-12 services-box-mob text-center">
      <div class="row-service row-service1">
        <div class="trans trans1 mx-auto">
          <svg class="mx-auto" x="0px" y="0px" width="75px" height="75px" viewBox="0 0 67 77" enable-background="new 0 0 77 77" xml:space="preserve">
<path  d="M49.101,28.311c-0.002-2.054-1.666-3.718-3.72-3.721h-8.676c0.342-1.816,0.515-3.66,0.515-5.508
...
<section id="classes" class="classes">
  <div class="container-fluid">
    <h1 class="title classes-title text-center">Training Courses</h1>
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="web-classes classes-div text-center">
            <div class="text-center classes-icon">
              <svg class="svg" x="0px" y="0px" width="68px" height="68px" viewBox="0 0 70 57" enable-background="new 0 0 70 57" xml:space="preserve">
            		<path d="M3.688,8.166h36.031v5.622h3.015V7.042c0-1.022-0.868-1.891-1.891-1.891H2.615
            			c-1.022,0-1.891,0.868-1.891,1.891v25.911c0,1.022,0.818,1.891,1.891,1.891h15.383v3.424h-3.373c-0.511,0-0.92,0.409-0.92,0.92
            			v1.788c0,0.511,0.409,0.92,0.92,0.92h14.31c0.511,0,0.92-0.409,0.92-0.92v-1.788c0-0.511-0.409-0.92-0.92-0.92h-3.424v-3.424
            			h7.053v-6.593H3.688V8.166z M21.729,30.193c0.716,0,1.329,0.613,1.329,1.329c0,0.716-0.613,1.329-1.329,1.329
            			c-0.716,0-1.329-0.613-1.329-1.329C20.4,30.806,21.014,30.193,21.729,30.193z"></path>
            		<path d="M47.231,15.934H36.703c-1.124,0-1.993,0.92-1.993,2.044v21.976c0,1.124,0.92,2.044,1.993,2.044h10.528
            			c1.124,0,2.044-0.92,2.044-2.044V17.928C49.276,16.803,48.356,15.934,47.231,15.934z M40.281,17.416h3.322
            			c0.255,0,0.46,0.204,0.46,0.46c0,0.255-0.204,0.46-0.46,0.46h-3.322c-0.255,0-0.46-0.204-0.46-0.46
            			C39.821,17.62,40.026,17.416,40.281,17.416z M41.968,40.466c-0.716,0-1.329-0.613-1.329-1.329s0.613-1.329,1.329-1.329
            ...
            <p class="paragraph text-center">The popularity and demand of digital marketing is fueling up by leaps and bounds.The count of digital marketing jobs is booming up.  We feel proud to have the best digital marketing trainers. We strive to come up with new ideas and strategies related to digital marketing for giving training on core digital concepts.   We believe in efficient training and try to bring out the best in students.</p>
            <br>
            <a class="btn btn-lg  btn-outline-warning2 margin-top" href="<?php echo base_url(); ?>web-design-and-development">Read More</a>
            <br>
          </div>
        </div>
        <div class="col-md-6">
          <div class="digital-classes classes-div text-center">
            <div class="text-center classes-icon">
              <svg class="svg" x="0px" y="0px" width="68px" height="68px" viewBox="0 0 70 57" enable-background="new 0 0 70 57" xml:space="preserve">
            		<path d="M3.688,8.166h36.031v5.622h3.015V7.042c0-1.022-0.868-1.891-1.891-1.891H2.615
            			c-1.022,0-1.891,0.868-1.891,1.891v25.911c0,1.022,0.818,1.891,1.891,1.891h15.383v3.424h-3.373c-0.511,0-0.92,0.409-0.92,0.92
            ...
            <h3 class="classes-sub-title text-center">Digital Marketing Training<br>Course</h3>
            <a class="btn btn-md btn-outline-warning btn-classes" href="<?php echo base_url(); ?>digital-marketing-services-kolhapur">READ MORE</a>
            <p class="paragraph text-center">
              When it comes to training students on today’s technology, Pixel Bazar is a leading institute. Our web design course content is created and updated by experienced web designers to match the present standards of web technologies. In our website program, we teach all the aspects of layout designing, coding, and testing. Many of our students are now placed in renowned companies and we feel happy for the same.
            </p>
            <a class="btn btn-lg text-center btn-outline-warning2 margin-top" href="<?php echo base_url(); ?>digital-marketing-training">Read More</a>
            <br>
          </div>
        </div>
      </div>
...
<div id="portfolio_mobile" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <!-- <a data-href="<?php echo base_url(); ?>assets/images/home_portfolio/1.jpg" class="boxout2 progressive replace"> -->
    ...
    <div class="carousel-item ">
      <!-- <a data-href="<?php echo base_url(); ?>assets/images/home_portfolio/3.jpg" class="boxout2 progressive replace"> -->
...
<!-- Contact End -->
  ...
  <script>
    $('document').ready(function(){
      var width1 = document.getElementById('scroller').offsetWidth;
      var width = width1-80;
      var req = width/3;
      req = req;
      $(".tile").width(req);
