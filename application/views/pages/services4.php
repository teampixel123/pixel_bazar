<?php
$title="Logo Design Designing in Kolhapur | PixelBazar";
$description="Best &#10004; Logo Design &#10004; Company in Kolhapur. Over 15+ Years of experience in all industry verticals. Book Now !";
$keywords="Logo design in Kolhapur, logo, company logo, business logo, logo creator, company logo design, custom logo design, business logo design, custom logo, logo design company in kolhapur, logo printing.";
include('head.php'); ?>
  ...
  <div class="container service-pg-container">
    <div class="row ">
      <div class="col-md-8">
          ...
          <img class="service-top-image" src="<?php echo base_url(); ?>assets/images/site/logo-pg.png" alt="" width="100%" >
      ...
      <div class="col-md-4">
          ...
          <img class="service-pg-img" src="<?php echo base_url(); ?>assets/images/site/webS.gif" alt="logo design, logo, company logo, business logo, logo creator, company logo design, custom logo design, business logo design, custom logo, best logo design, logo design services " width="120%" height="360px;">
          ...
          <div class="service-right-menu">
              <div class="row" >
                  <img class="service-img" src="<?php echo base_url(); ?>assets/images/site/blank.jpg" alt="design my logo, design your logo, logo service, brand logo design, new logo design, corporate logo design, buy logo, buy logo design, logo design site, best logo designers, great logo design, developer logo, simple logo design, brand logo, good logo design, logo and design, professional custom logo design ">
                      <p class="float-right align-self-center service-left-title">Brand Identity <br>For Next Element</p>
              </div>
              <div class="row" >
                  <img class="service-img" src="<?php echo base_url(); ?>assets/images/site/blank.jpg" alt="cool logo designs, graphic design custom logo,  new logo ">
                      <p class="float-right align-self-center service-left-title">Brand Identity <br>For Next Element</p>
              </div>
              <div class="row" >
                  <img class="service-img" src="<?php echo base_url(); ?>assets/images/site/blank.jpg" alt="custom logo design online free, logo design portfolio, creative logo maker, logo design blog, business card logo design, web logo designers, logo design help, logo maker design ">
                      <p class="float-right align-self-center service-left-title">Brand Identity <br>For Next Element</p>
              </div>
              <div class="row" >
                  <img class="service-img" src="<?php echo base_url(); ?>assets/images/site/blank.jpg" alt="logo design, logo, company logo, business logo, logo creator, company logo design, custom logo design">
                      <p class="float-right align-self-center service-left-title">Brand Identity <br>For Next Element</p>
              </div>
              <div class="row">
          ...
          <div class="service-right-menu-bottom">
            <div class="row" >
                <img class="service-img" src="<?php echo base_url(); ?>assets/images/site/blank.jpg" alt="cool logo designs, graphic design custom logo, company logo, business logo, logo creator">
                <img class="service-img" src="<?php echo base_url(); ?>assets/images/site/blank.jpg" alt="design my logo, design your logo, logo service, brand logo design, new logo design">
            </div>
            <div class="row" >
                <img class="service-img" src="<?php echo base_url(); ?>assets/images/site/blank.jpg" alt="business logo design, custom logo, best logo design, logo design services">
                <img class="service-img" src="<?php echo base_url(); ?>assets/images/site/blank.jpg" alt="design my logo, design your logo, logo service, brand logo design, new logo design, corporate logo design">
            </div>
          </div>
      </div>
    </div>
