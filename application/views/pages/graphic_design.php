    ...
    <div class="row ">
      <div class="col-md-8">
          ...
          <div class="social-media">
            ...
            <a class="display_mobile" id="whats_app" target="_blank" href="https://web.whatsapp.com/send?text=<?php echo base_url(); ?>graphic-design-services-kolhapur">
          ...
          <p>The word ‘Graphic’ defines itself that customers are looking for images which can show their business in an effective manner. We all know that a beautiful design can say thousands of words.  However coming up with such eye-candy designs is not a cup of tea for all. These designs need to be created by developing the ideas and nurturing them passionately for getting desired outcomes. So, what makes a design beautiful? Well! It should be attractive, relevant and posses the capability of communicating with the customers.</p>
          <img class="service-top-image" src="<?php echo base_url(); ?>assets/images/site/graphic-design-services-kolhapur.jpg" alt="Graphic Design in Kolhapur, Graphic Design services in kolhapur, graphic art, graphic design logo, graphic design books, digital graphic designer, graphic art designer, graphic design company in kolhapur" width="100%" >
          <h3 class="service-sub-title">Why Pixel Bazar</h3>

          <p>Designing is an art, and our designers are passionate about this art. We believe that every creative design sends a message to customers. The layout, color, design and font should speak about your business. We believe in creating designs which can remain in customers’ mind long after he has seen it! Whether you are looking for brochure, visiting card, signage, website, or flyer designing, our designs are always fresh like baked bread! </p>
          <p>Our graphic design team understands the clients’ requirements and their core business. Once done, we invest our time in coming up with best designs which they will love to see and can create a wow factor among their target audience. The best part of our designing team is we don’t believe in trial error. Which implies whatever designs we create are so perfect that clients’ approve them in the first go. This saves their time and make them appreciate our services. Obviously, their appreciation works as a trophy for us.</p>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="portfolio_form" method="post" class="message-form clear" action="<?php echo base_url(); ?>Welcome/send_service_email">
              <input type="hidden" name="page_url" value="<?php echo base_url(); ?>graphic-design-services-kolhapur">
              <input type="hidden" name="title" value="Leading Graphic design company in Kolhapur">
              <div class="form-row">
