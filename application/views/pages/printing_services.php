      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="portfolio_form" method="post" class="message-form clear" action="<?php echo base_url(); ?>Welcome/send_service_email">
              <input type="hidden" name="page_url" value="<?php echo base_url(); ?>printing-services-kolhapur">
              <input type="hidden" name="title" value="Clear, Crisp and Creative Printing Solutions">
              <div class="form-row">
