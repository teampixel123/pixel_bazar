    ...
    <div class="row ">
      <div class="col-md-8">
          ...
          <div class="social-media">
            ...
            <a class="display_mobile" target="_blank" href="whatsapp://send?text=<?php echo base_url();?>strategic-branding-kolhapur">
          ...
          <p>One of the most challenging concepts in business management that put to test skills of seasoned strategic planners is no doubt strategic branding.  It is one of the terms, which have several implications. </p>
          <p>At Pixel Bazar, we believe in integrating our exclusive branding philosophy into the concerned process for ensuring effective positioning of your final products and services. </p>
          ...
          <img class="service-top-image" src="<?php echo base_url(); ?>assets/images/site/brand_design.jpg" alt="Strategic Branding Services, branding in kolhapur, Brand Identity, Branding" width="100%" >
